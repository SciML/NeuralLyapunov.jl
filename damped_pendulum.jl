...
output_dim = 1
κ=20.0
pde_system_log, lyapunov_func = NeuralLyapunovPDESystem(pendulum_dynamics, lb, ub, output_dim, relu=(t)->log(1.0 + exp( κ * t)))
...
pde_system_relu, _ = NeuralLyapunovPDESystem(pendulum_dynamics, lb, ub, output_dim)
